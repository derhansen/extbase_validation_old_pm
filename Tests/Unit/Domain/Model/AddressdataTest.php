...
/**
 * Test case for class Tx_ValidationExamples_Domain_Model_Addressdata.
 *
 * @version $Id$
 ...
 */
class Tx_ValidationExamples_Domain_Model_AddressdataTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
